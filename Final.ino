...
class Humedad{
  private:
    ...
    const int AirValue = 160;  // Medimos valor en seco
    const int WaterValue = 6;  // Medimos valor en agua
    int16_t humedad;
    int16_t posicion;
  public:
...
//////////////////////////////////////////////////////
  ...
  String MyWriteAPIKey="KLN83WW7CDCRJJ0Z"; // Escribe la clave de tu canal ThingSpeak
#else 
...
void loop() {
  ...
  Salinidad sensor0(0);
  Temperatura sensor1(1);
  Humedad sensor2(2);
  Iluminacion sensor3(4);
  connectWiFi();
